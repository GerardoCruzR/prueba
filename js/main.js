...
/*--------------- navigation menu ---------------*/
// Función para traducir la página a inglés
function translateToEnglish() {
  // Obtener el contenido actual de la página
  var content = document.body.innerHTML;

  // Realizar la traducción a través de Google Translate
  var url = "https://translate.googleapis.com/translate_a/single?client=gtx&sl=es&tl=en&dt=t&q=" + encodeURIComponent(content);

  // Realizar una solicitud HTTP para obtener la traducción
  fetch(url)
    .then(response => response.json())
    .then(data => {
      // Actualizar el contenido de la página con la traducción
      document.body.innerHTML = data[0][0][0];
